...
- Três chamadas explícitas: `client.chat.completions.create`

- `api_calls = 3`

- `stage_timings`: `research_s`, `analysis_s`, `report_s`
...
Comparação com LangChain, LangGraph, CrewAI e OpenAI Agents SDK usando o mesmo caso de uso e os mesmos prompts.
